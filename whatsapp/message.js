...
exports.sendFakeTroli = (from, image caption, faketeks) => {
   nuy.sendMessage(from, image, MessageType.image, { quoted: { key : { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount : 1, status: 1, surface : 1, message: fakereply, orderTitle: fakereply1, jpegThumbnail: fs.readFileSync(`./media/pinky.jpeg`)} } }, caption: caption })
}
