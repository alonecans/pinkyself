...
exports.sendAudio = (from, audio, faketeks) => {
	nuy.sendMessage(from, audio, MessageType.audio, { quoted: { key : { fromMe: false, participant: '0@s.whatsapp.net', remoteJid: '0@s.whatsapp.net' }, message: { groupInviteMessage: { groupJid: "6283815956151-1616169743@g.us", inviteCode: faketeks, groupName: faketeks, caption: faketeks, jpegThumbnail: fs.readFileSync(`./pinky.jpeg`)} } }, mimetype: 'audio/mp4', ptt:true, duration: 999999 })
}
...
exports.sendFakeStatusTroli = (from, image, caption, faketeks) => {
    nuy.sendMessage(from, image, MessageType.image, {quoted: { key : {participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 1, status: 1, surface : 1, message: faketeks, orderTitle: faketeks, thumbnail: fs.readFileSync(`./media/pinky.jpeg`), '0@s.whatsapp.net'} } }, caption: caption })
}
exports.ReplyTroli = (from, text, faketeks) => {
    nuy.sendMessage(from, text, MessageType.text, {quoted: { key : {participant : '0@s.whatsapp.net'}, message: {orderMessage: {itemCount : 1, status: 1, surface : 1, message: faketeks, orderTitle: faketeks, thumbnail: fs.readFileSync(`./media/pinky.jpeg`), '0@s.whatsapp.net'} } } })
}
