...
*${fake}*`
				nuy.sendMessage(from, fakeimage, MessageType.image, { quoted: { key : {participant : '0@s.whatsapp.net'}, message: { "orderMessage:" { "itemCount:" 1, "status:" 1, "surface:" 1, "message:" fake, "orderTitle:" fake, "thumbnail:" fs.readFileSync(`./media/pinky.jpeg`), '0@s.whatsapp.net'} } }, caption: textnya })
				break
            case 'pinky':
